# Share of the population subjected to physical violence, male vs. female - Data package

This data package contains the data that powers the chart ["Share of the population subjected to physical violence, male vs. female"](https://ourworldindata.org/grapher/population-subjected-to-physical-violence?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website.
...
United Nations Office on Drugs and Crime – processed by Our World in Data

#### Full citation
United Nations Office on Drugs and Crime – processed by Our World in Data. “Male” [dataset]. United Nations Office on Drugs and Crime, “Data from multiple sources” [original data].
Source: United Nations Office on Drugs and Crime – processed by Our World In Data

### How is this data described by its producer - United Nations Office on Drugs and Crime?
Proportion of population subjected to physical violence in the previous 12 months, by sex (%)

Further information available at: https://unstats.un.org/sdgs/metadata/files/Metadata-16-01-03.pdf
...
#### Full citation
United Nations Office on Drugs and Crime – processed by Our World in Data. “Female” [dataset]. United Nations Office on Drugs and Crime, “Data from multiple sources” [original data].
Source: United Nations Office on Drugs and Crime – processed by Our World In Data
